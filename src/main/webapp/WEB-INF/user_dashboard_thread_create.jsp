...
<body>
	...
	<div>
		<h5><a href="/">Dashboard</a> > <a href="/forums/${forumMainTopic.getTitle()}">${forumMainTopic.getTitle()}</a> > <a href="/forums/${forumMainTopic.getTitle()}/${forumSubTopic.getTitle()}/page/0">${forumSubTopic.getTitle()}</a> > <u>New Thread</u></h5>
		<br>
		<h2>Create a new thread related to ${forumMainTopic.getTitle()} -
			${forumSubTopic.getTitle()}:</h2>
		<br>
		<form:form
			action="/forums/${forumMainTopic.getTitle()}/${forumSubTopic.getTitle()}/create/topic"
			method="POST" modelAttribute="threadForm">
			...
			<ul>
				...
				<form:input path="forumSubTopic" type="text" value="${forumSubTopic.getId()}"
					hidden="true" />
				<!-- <br>
	...
	<label>User Thread ID: </label> -->
				<form:input path="userThread" type="text" value="${currentUser.getId()}"
					hidden="true" />
				<!-- <br>
