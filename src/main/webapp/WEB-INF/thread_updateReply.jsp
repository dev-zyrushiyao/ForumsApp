				...
				<body>
					...
					<main class="main-content-logged">
						...
						<div>
							...
							<h2 class="margin-bot">Edit comment</h2>

							<form:form
								action="/admin/forums/${forumMainTopic.getTitle()}/${forumSubTopic.getTitle()}/thread/${threadModel.getId()}/update/info/reply/${commentModel.getId()}"
								method="POST" modelAttribute="updateReplyForm">
